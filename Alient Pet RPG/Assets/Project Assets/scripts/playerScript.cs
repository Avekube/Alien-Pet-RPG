...
public class playerScript : MonoBehaviour
{
    ...
    void Start ()
    {
        ...
        playerWalkingSoundSource = GetComponent<AudioSource>();
        //playerWalkingSoundSource.clip = playerWalkingClip;
        movement = new Vector2();

        //step1 = (AudioClip)Resources.Load("Project Assets/audio/step1.wav");
	}
    ...
    protected void changeAnimationStates()
    {
        ...
        switch (movement.normalized.ToString())
        {
            case "(0.0, -1.0)": //down
                ...
                temp = Vector2.down;
                if(!playerWalkingSoundSource.isPlaying)
            ...
            case "(0.0, 0.0)":
                ...
                playerWalkingSoundSource.Pause();
                break;
        }
